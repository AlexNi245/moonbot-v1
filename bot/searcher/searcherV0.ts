...
//This Search is fired after each Router Transaction and try to find all pools from all supported factories that are containing one token of the corospending path
export const searchV0 = async (provider: StaticJsonRpcProvider, uniswapV2QueryAddress: string, pools: string[], target: string): Promise<ArbitrageOpportunity[]> => {
